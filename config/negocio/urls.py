...
urlpatterns = [
    ...
    path('pedidos/<int:pk>/gasto/',            views.pedido_gasto_add,    name='pedido_gasto_add'),
    ...
    path('contabilidad/excel/',                views.contabilidad_excel,  name='contabilidad_excel'),
    ...
    path('tipos/alias/<int:pk>/eliminar/',      views.tipo_alias_delete,   name='tipo_alias_delete'),
